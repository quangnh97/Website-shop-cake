      ...
      <div class="col-sm-9">
        ...
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <div class="single-item-desc"> {{$sanpham->description }}
            </div>
            <div class="space20">&nbsp;</div>
            ...
            <div class="col-sm-4">
              <div class="single-item">
                ...
                <div class="single-item-header">
                  <a href="{{route('productDetail',$rp->id)}}"><img src="source/image/product/{{$rp->image}}" alt="" height="250px"></a>
                </div>
                <div class="single-item-body">
                  <p class="single-item-title">{{$rp->name}}</p>
                  <p class="single-item-price" style="font-size: 18px">
                    @if($rp->promotion_price == 0)
                    <span class = "flash-del">{{$rp->unit_price}} đồng</span>
                    @else
                    <span class = "flash-del">{{$rp->unit_price}} đồng</span>
                    <span class="flash-sale">{{$rp->promotion_price}} đồng</span>
                    @endif
                  </p>
                </div>
            ...
            <div class="beta-sales beta-lists">
              ...
              <div class="media beta-sales-item">
                ...
                <div class="media-body">
                  {{$p->name}}
                  @if($rp->promotion_price == 0)
                  <span class = "flash-del">{{$p->unit_price}} đồng</span>
                  @else
                  <span class = "flash-del">{{$p->unit_price}} đồng</span>
                  <span class="flash-sale">{{$p->promotion_price}} đồng</span>
                  @endif
                </div>
              </div>
              @endforeach
